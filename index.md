...
//          text: String.format('sfmax = {0} cpd', round(sfmax, 2))
          ...
          y: anoise,
//          text: String.format('anoise = {0} µV', round(anoise, 2))
        }, {
          x: sfthreshold,
...
/*
        options.annotations[1] = {
          y: amax,
          text: String.format('amax = {0} µV', round(amax, 2))
        };
*/
        functionPlot(options);
      }
  ...
  <body>
        ...
        <table border="0" cellspacing="10">
          <tr>
            ...
            <td colspan="2" valign="top">
              <p>Paste tabular spatial frequencies (cpd) / amplitudes (µV) data into the textfield.</p>
            </td>
          </tr>
          <tr>
    ...
    <table border="0" cellpadding="5">
      <tr>
        ...
        <td valign="top" align="left">
          ...
          <table id="resultsRicker" class="compact stripe">
            ...
            <tr><td>RMSE</td><td align="right"></td><td>µV</td></tr>
            <tr><td>a<sub>max</sub></td><td align="right"></td><td>µV</td></tr>
            <tr><td>sf<sub>max</sub></td><td align="right"></td><td>cpd</td></tr>
            <tr><td>a<sub>noise</sub></td><td align="right"></td><td>µV</td></tr>
      ...
      <tr>
        <td colspan="4" style="font-size:12px; color:#686868;">
          <p>
            Copyright © 2018 <a href="http://www.eye-tuebingen.de/zrennerlab/members/torsten-strasser" target="_blank">Torsten Straﬂer</a>, Institute for Ophthalmic Research, Tuebingen, Germany
          </p>
        </td>
      </tr>
    </table>
